...
import org.openqa.selenium.WebDriver;
	...
	class ModifyUserPOM
	{
		...
		static void modify()
		{
			try
			{
				...
				Thread.sleep(3000);
				oPage.getlastName().sendKeys("Modified");
				Thread.sleep(3000);
				oPage.getSaveChangesBtn().click();
				Thread.sleep(4000);
			}catch(Exception e)
			{
				e.printStackTrace();
	...
	public class Test2 {
		...
		public static void main(String[] args) {
			ModifyUserPOM.launchBrowser();
			ModifyUserPOM.navigate();
			ModifyUserPOM.login();
			ModifyUserPOM.minimizeFlyOutWindow();
			ModifyUserPOM.createuser();
			ModifyUserPOM.modify();
			ModifyUserPOM.deleteuser();
			ModifyUserPOM.logout();
			ModifyUserPOM.closeApplication();
