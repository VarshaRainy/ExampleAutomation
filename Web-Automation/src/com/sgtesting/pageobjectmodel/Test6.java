...
class ModifyProjectPOM
{
	...
	static void ModifyProject()
	{
		try
		{
			...
			Thread.sleep(3000);
			oPage.getmodifyprojectdescription().sendKeys(" Java Script");
			Thread.sleep(3000);
...
public class Test6 {
	...
	public static void main(String[] args) {
		ModifyProjectPOM.launchBrowser();
		ModifyProjectPOM.navigate();
		ModifyProjectPOM.login();
		ModifyProjectPOM.minimizeFlyOutWindow();
		ModifyProjectPOM.CreateCustomer();
		ModifyProjectPOM.CreateProject();
		ModifyProjectPOM.ModifyProject();
		ModifyProjectPOM.DeleteProject();
		ModifyProjectPOM.deletecustomer();
		ModifyProjectPOM.logout();
		ModifyProjectPOM.closeApplication();
