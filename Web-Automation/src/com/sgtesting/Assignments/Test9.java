...
public class Test9 {
	...
	public static void main(String[] args) {
		...
		AdvancedTest1.launchBrowser();
		AdvancedTest1.navigate();
		AdvancedTest1.login();
		AdvancedTest1.minimizeFlyOutWindow();
		AdvancedTest1.createUser1();
		AdvancedTest1.createUser2();
		AdvancedTest1.createUser3();
		AdvancedTest1.logout();
		
		AdvancedTest1.loginUser1();
		AdvancedTest1.logout();
		
		AdvancedTest1.loginUser2();
		AdvancedTest1.logout();
		
		AdvancedTest1.loginUser3();
		AdvancedTest1.logout();
		
		AdvancedTest1.login();
		
		AdvancedTest1.modifyUser1();
		AdvancedTest1.modifyUser2();
		AdvancedTest1.modifyUser3();
		AdvancedTest1.logout();
		
		AdvancedTest1.loginUser11();
		AdvancedTest1.logout();
		
		AdvancedTest1.loginUser22();
		AdvancedTest1.logout();
		
		AdvancedTest1.loginUser33();
		AdvancedTest1.logout();
		
		AdvancedTest1.login();
		
		AdvancedTest1.deleteUser1();
		AdvancedTest1.deleteUser2();
		AdvancedTest1.deleteUser3();
		
		AdvancedTest1.logout();
		AdvancedTest1.closeApplication();
