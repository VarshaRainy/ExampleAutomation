...
public class CreateProject {
	...
	public static void main(String[] args) {
		...
		CreateProjectTest.launchBrowser();
		CreateProjectTest.navigate();
		CreateProjectTest.login();
		CreateProjectTest.minimizeFlyOutWindow();
		CreateProjectTest.CreateCustomer();
		CreateProjectTest.createProject();
		CreateProjectTest.deleteproject();
		CreateProjectTest.DeleteCustomer();
		CreateProjectTest.logout();
		CreateProjectTest.closeApplication();
	}
