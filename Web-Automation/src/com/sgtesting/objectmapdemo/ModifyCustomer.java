...
class ModifyCustomerTest
{
	...
	static void Modified()
	{
		try
		{
			...
			Thread.sleep(4000);
			oBrowser.findElement(objmap.getLocator("ModifiedChanges")).sendKeys(" Programming");
			Thread.sleep(4000);
			oBrowser.findElement(objmap.getLocator("closebtn")).click();
			Thread.sleep(4000);
		}catch(Exception e)
		{
			e.printStackTrace();
		}
		System.out.println("Modified Customer Successful");
	}
